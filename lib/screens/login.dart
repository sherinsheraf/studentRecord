...
class _ScreenLoginState extends State<ScreenLogin> {
  ...
  late final String SAVE_KEY_NAME; // Declare as late final
  ...
  void initState() {
    super.initState();
    SAVE_KEY_NAME = 'userLoggedIn'; // Initialize SAVE_KEY_NAME here
  }
          ...
          child: Center(
            child: Column(
              children: [
                ...
                Text("Enter your credentials to login", style: regularTextStyle),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    prefixIcon: Icon(
                      ...
                      color: _focusNode.hasFocus ? Colors.black : Color.fromARGB(255, 26, 22, 22),
                    ),
                    hintText: 'Password',
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(18),
